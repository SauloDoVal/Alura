...
//	}
	...
	// for every employee by applying this method to the SuperClass Funcionario, the
	...
	// Due to Polymorphism, whenever a Gerente or a EditorVideo calls for the
	// funtion, their on bonus will be called, we can check that due to a
